            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: _selectedPaymentMethod == 'Visa' ? Colors.blueAccent[200] : Colors.transparent,
          ...
          child: Column(
            children: [
              Container(
                padding: EdgeInsets.all(8.0),
                decoration: BoxDecoration(
                  color: _selectedPaymentMethod == 'Mastercard' ? Colors.blueAccent[200] : Colors.transparent,
                  borderRadius: BorderRadius.circular(50.0),
                ),
                child: Icon(Icons.credit_card),
              ),
          ...
          child: Column(
            children: [
              Container(
                padding: EdgeInsets.all(8.0),
                decoration: BoxDecoration(
                  color: _selectedPaymentMethod == 'PayPal' ? Colors.blueAccent[200] : Colors.transparent,
                  borderRadius: BorderRadius.circular(50.0),
                ),
